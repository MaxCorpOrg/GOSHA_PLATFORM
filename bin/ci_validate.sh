...
echo "[1/7] Проверка ключевых файлов"
required_paths=(
...
echo "[2/7] Проверка синтаксиса shell-файлов"
...
echo "[3/7] Проверка Python AST для platform/ops"
