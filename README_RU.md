...
- `docs/GOSHA_FLEET_CONTRACT_SCHEMA_PR1_RU.md`
  - проверенная спецификация первого P0-пакета: сущности флота, наследование, привязка устройств и совместимость API
- `local_only/`
...
- Для реализации первого пакета `fleet-contract-schema` дополнительно читать `docs/GOSHA_FLEET_CONTRACT_SCHEMA_PR1_RU.md`.
