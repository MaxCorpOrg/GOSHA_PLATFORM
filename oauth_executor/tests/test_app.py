...
from oauth_executor.app import SESSION_COOKIE_NAME, app


class ExecutorAppSessionCookieTests(unittest.TestCase):
    def test_executor_uses_distinct_session_cookie_name(self) -> None:
