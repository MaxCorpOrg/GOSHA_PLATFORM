...
7. Если задача про сервер:
   ...
   - `ops/AGENTS.md`
8. Если задача про панель и совместимый шлюз платформы `Гоша`:
   - `docs/GOSHA_LOCAL_SELFHOST_RUNBOOK_RU.md`
   - `platform/AGENTS.md`
   - `docs/GOSHA_ASSISTANT_CONTROL_PANEL_SPEC_RU.md`
9. Если задача уже перешла к собственной прошивке:
   - `/home/max/GOSHA_FIRMWARE/START_HERE_FOR_NEW_CHAT.md`
10. Если задача относится к новому мобильному клиенту:
