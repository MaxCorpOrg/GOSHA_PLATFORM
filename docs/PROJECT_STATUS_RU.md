...
- Новый мобильный клиент `GOSHA_MOBILE` ещё не проверен на реальном телефоне с живым кодом подключения и живым роботом.
...
6. После стабилизации голосового контура перейти к следующему шагу в `/home/max/GOSHA_FIRMWARE`:
